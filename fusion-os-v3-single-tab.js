/**
 * FUSION OS v3.0 - LIVROVIVO EDITION (SINGLE TAB)
 * Architecture: Widget Loader / Self-Contained / IIFE
 * Features: Permissões, Fusões Inteligentes, UI/UX Refinada
 * Layout: 1 aba única com tudo integrado em stacks/cards aninhados
 */
...
const FusionOS = (() => {
    ...
    const UI = {
        styles: `
            /* ═══════════════════════════════════════════════════════════════
               FUSION OS v3.0 - ENHANCED STYLESHEET (SINGLE TAB)
               ═══════════════════════════════════════════════════════════════ */
